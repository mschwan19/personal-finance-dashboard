    ...
    <div class="modal-card">
      ...
      <form @submit.prevent="submitTransaction" class="transaction-form">
        ...
        <div class="form-group">
          ...
          <input type="number" step="0.01" v-model="formData.amount" required placeholder="z.B. 45.50" />
        </div>
...
<style scoped>
/* Das CSS bleibt komplett gleich */
...
.form-group input, .form-group select { padding: 12px; border: 1px solid #e2e8f0; border-radius: var(--radius-md); font-size: 1rem; font-family: inherit; }
